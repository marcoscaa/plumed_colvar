...
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ */
#ifndef __PLUMED_colvar_ProtonDefectBase_h
#define __PLUMED_colvar_ProtonDefectBase_h
#include "Colvar.h"
...
class ProtonDefectBase : public Colvar {
  bool pbc;
  bool serial;
  NeighborList *nl;
  std::vector<PLMD::AtomNumber> list_a,list_b;
...
public:
  explicit ProtonDefectBase(const ActionOptions&);
  ~ProtonDefectBase();
// active methods:
